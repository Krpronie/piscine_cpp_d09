...
void
CommunicationDevice::send(std::string const &user,std::string const &message) const
{
    _api.sendMessage(user, message);
}

void
CommunicationDevice::receive(std::string const &user,std::string &message) const
{
